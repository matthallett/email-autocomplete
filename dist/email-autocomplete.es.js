...
var EmailAutocomplete = function EmailAutocomplete(elem, options) {
  ...
  var currentValStyles = "visibility:hidden;position:absolute;display:inline-block;font-family:".concat(this.fieldStyle.fontFamily, ";font-weight:").concat(this.fieldStyle.fontWeight, ";letter-spacing:").concat(this.fieldStyle.letterSpacing, ";");
  ...
  var suggestionOverlayStyles = "display:block;box-sizing:content-box;line-height:".concat(this.fieldStyle.lineHeight, ";padding-top:").concat(heightPad, "px;padding-bottom:").concat(heightPad, "px;font-family:").concat(this.fieldStyle.fontFamily, ";font-weight:").concat(this.fieldStyle.fontWeight, ";letter-spacing:").concat(this.fieldStyle.letterSpacing, ";position:absolute;top:0;left:0;");
